...
# git then tells us how many files were commited (3)
```
...
git remote set-url orgin git@github.com:<YOUR GITHUB NAME>/REPOSITORY_name
...
git remote set-url origin git@github.com:genehomics/genehomics
