---
title: "03_install_nextflow_WINDOWS"
author: "JR"
date: "2024-02-07"
output: html_document
---

# IMPORTANT OPTIONAL - very difficult recommened skipping to level 5.
# All needed output files from this pipeline are provided here:
https://rinnformatics.colorado.edu/


# Goal: to install nextflow on a windows laptop computer

# Youtube video for this class here:
# IMPORTANT : we were not able to get this to work.
...
# First we will install nextflow on a WINDOWS laptop. 
