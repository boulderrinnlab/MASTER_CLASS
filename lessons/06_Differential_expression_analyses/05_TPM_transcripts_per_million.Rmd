...
You have three columns for each timepoint and 5 time points.
...
# For looping to find average TPM
...
###### ExeRcise #######
What about standard deviation of TPM values across replicates and time points for each gen???
# Let's revisist our previous forloop and now do it for avg and sd in one table.
```{r}
