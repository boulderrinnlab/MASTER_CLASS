...
# Filter to sig genes
sig_rlog_counts_matrix_mouse_long <- rlog_counts_matrix_mouse_long[rrownames(rlog_counts_matrix_mouse_long) %in% unique_sig_genes, ]


pheatmap(rlog_counts_matrix_mouse_long, 
         cluster_rows = TRUE,  
         cluster_cols = TRUE,  
         scale = "row",        
         show_rownames = FALSE, 
