...
#####TODO add overlap with RNAseq sig genes !



##### START HERE WARNING OVERLAPS MAYBE THE WRONG WAY !!!
# Step 2: Create .bed files for dox and non-dox peaks
```{r}
...
# Bottom line not sure this is the best approach let's trying using DESEQ on ATACseq !!
